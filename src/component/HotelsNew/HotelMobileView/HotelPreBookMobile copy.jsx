...
<div className="hotelTravellerMobile-wrapper">
    ...
    <div className="hotelTravellerMobile-row">
      <div className="hotelTravellerMobile-inputGroup">
        ...
        <div className="hotelTravellerMobile-mobileRow">
          ...
          <input type="text" placeholder="Please Enter Mobile No" />
        </div>
      </div>
    </div>

    {/* Add More Guest */}
    <p className="hotelTravellerMobile-addMore" onClick={() => setShowAddGuest(true)} > + Add More Guest </p>
  ...
  <div className="hotelTravellerMobile-savedGuests">
    ...
    {savedGuests.map((guest, index) => (
      <div key={index} className="hotelTravellerMobile-savedGuestItem">
        <input type="checkbox" />
      ...
      {showAddGuest && (
        <div className="hotelTravellerMobile-addGuest">
          ...
          <button onClick={handleSaveGuest} className="hotelTravellerMobile-saveBtn">
            Save Guest
          </button>
            ...
            >
              ...
              <div className="hotelTravellerMobile-priceBar">
                <div>
                  ...
                  <strong style={{color:'#878787'}}>₹ {Math.round(hotelPreBookData?.data?.HotelResult[0]?.Rooms[0]?.NetAmount)}</strong>
                </div>
