    ...
    <div className="full-container">
      <div>
        <ul className="custom-menu-container">
          <li>
            <Link to="/bookings/hotel">Hotel</Link>
          </li>
          <li>
            <Link to="/bookings/tour">Package</Link>
          </li>
          <li className="active">
            <Link to="/bookings/sightseeing">Sightseeing</Link>
          </li>
          <li>
...
const SightBookingTable = ({ heading, data }) => {
...
export default SightBookingTable;
