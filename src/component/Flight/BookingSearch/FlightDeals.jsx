...
const FlightDeals = () => {
  ...
  const getRoundTripUrl = (dest, org) => {
    return `http://localhost:3000/round/dest_${dest}*org_${org}*dep_${tomorrowDate}*arr_${tomorrowDate}*px_1-0-0*jt_2*cbn_2`;
  };
  ...
  return (
    <div className="alldealTab">
      <Container className="deal-section dealSection">
              ...
              <tr className="main-row dealLength5">
                <td valign="top" className="cell-0">
                  <div className="deal-box">
                    <Link className="text-decoration-none" to={getOneWayUrl("YVR", "SFO")}>
                      <figure>
                        <img
        ...
        <div className="dealcontainer2 tab-content" style={{ display: 'unset' }}>
        <table className="main-table">
          <tbody>
            <tr className="main-row dealLength5">
              <td valign="top" className="cell-0">
