...
export const FlightListInfoInternational = ({
  ...
  return (
    <>
      {flight && idx === flight.ResultIndex ? (
        <div className="detailDiv detail_Interational_tg">
                  ...
                  <div className="flightInfoInnerDiv6">
                    ...
                    >
                      ...
                      >
                        ...
                        <p>₹{flight.FareBreakdown[0].BaseFare}</p>
                      </div>
                      <div
                        style={{
                          width: "100%",
                      ...
                      >
                        ...
                        <p>₹{flight.FareBreakdown[0].Tax}</p>
                      </div>
                      <div
                        style={{
                          width: "100%",
                    ...
                    {flight.FareBreakdown[1] && (
                      ...
                      >
                        ...
                        >
                          <p className="flightInfoPara7">Base Fare</p>
                          <p>₹{flight.FareBreakdown[1].BaseFare}</p>
                        </div>
                        <div
                          style={{
                            width: "100%",
                        ...
                        >
                          <p className="flightInfoPara7">Tax</p>
                          <p>₹{flight.FareBreakdown[1].Tax}</p>
                        </div>
                        <div
                          style={{
                            width: "100%",
                    ...
                    {flight.FareBreakdown[2] && (
                      ...
                      >
                        ...
                        >
                          <p className="flightInfoPara7">Base Fare</p>
                          <p>₹{flight.FareBreakdown[2].BaseFare}</p>
                        </div>
                        <div
                          style={{
                            width: "100%",
                        ...
                        >
                          <p className="flightInfoPara7">Tax</p>
                          <p>₹{flight.FareBreakdown[2].Tax}</p>
                        </div>
                        <div
                          style={{
                            width: "100%",
                    ...
                    <div className="flightInfoMainInner1">
                      ...
                      <p className="flightInfoPara9">₹{flight.Fare.BaseFare}</p>
                    </div>
                    <div className="flightInfoMainDivInner4">
                      <p className="flightInfoPar10">Total Tax</p>
                      <p className="flightInfoPara9">₹{flight.Fare.Tax}</p>
                    </div>
                    <div className="flightInfoMainInner1">
