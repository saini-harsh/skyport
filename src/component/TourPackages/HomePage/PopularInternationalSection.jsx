...
const PopularInternationalSection = () => {
  ...
  useEffect(() => {
    const fetchInternationalDest = async () => {
      try {
        const response = await axios.get("https://admin.tripgoonline.com/api/HolidayPackages/InternationalDestinations");
      ...
      {destinations.length > 0 && (
        <section className="destinations-one">
            ...
            {destinations.map((destination, index) => (
              <Col key={index} md={index === 0 || index === 2 ? 3 : 6}>
                <div className="destinations-one__single">
                  <Link to={`/tour/${destination.slug}`} className="destinations-one__img">
                    <img
                    ...
                    <div className="destinations-one__button">
                      {/* <Link to="/tour/italy">6 tours</Link> */}
                    </div>
                  </Link>
                </div>
              </Col>
          ...
          <div className="tourBtn3">
            <Link to="/tour/international">Explore More</Link>
          </div>
        </section>
      )}
    </>
